...
export const packages = [
  {
    ...
    name: "✨ חבילת היכרות",
    description:
      "2 מפגשים (סה״כ 6 שעות) של חוויה אישית. בחרי 2 שירותים לשילוב, ותיהני מטעימה מושלמת מבסטי!",
  ...
  },
  {
    ...
    name: "💝 חבילת VIP",
    description:
      "4 מפגשים מותאמים אישית + הפתעות מפנקות. שילוב של כמה שירותים לאורך החודש, עם פינוקים ייחודיים שיגיעו עד אלייך!",
