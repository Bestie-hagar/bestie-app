...
export const services = [
  ...
  },
  {
    ...
    description:
      "גבות שפם בחוט (ניקוי), מחליק או בייביליס, מסיכת פנים, הבהרת שיער פנים וגוף, הלבנת שיניים ביתית, מסז׳ קרקפת וכללי, נעשה יחד גם לק ברגליים וידיים, הסרת שיער בשעווה אם צריך וכל דבר אחר שתבחרי. בקלילות ועד הבית.",
    duration: "שעתיים",
    investment: "300 ₪",
    icon: "👸",
